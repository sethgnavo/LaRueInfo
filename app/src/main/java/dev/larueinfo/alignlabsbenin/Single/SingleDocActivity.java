...
import dev.larueinfo.alignlabsbenin.DocActivity;
...
public class SingleDocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String date = intent.getStringExtra(DocActivity.KEY);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SingleDocActivity.this);
                builder.setTitle("Votre Commentaire");
                // Set up the input
                final EditText input = new EditText(SingleDocActivity.this);
        ...
        backend = new Firebase("https://yadialigninfo.firebaseio.com/Doc/" + date);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.favoris) {
            ...
            commentRef.push().setValue(map);*/
            Toast.makeText(getApplicationContext(), "Bientôt disponible", Toast.LENGTH_LONG).show();
        }
        if (id == R.id.like) {
